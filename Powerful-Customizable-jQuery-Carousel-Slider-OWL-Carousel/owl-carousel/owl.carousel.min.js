    ...
    var l = {
        ...
        loops: function() {
            ...
            for (e = 0; e < this.itemsAmount; e += 1)
                (b += this.itemWidth),
                this.positionsInArray.push(-b), !0 === this.options.scrollPerPage &&
                ((c = f(this.$owlItems[e])),
        ...
        goTo: function(a, b, e) {
            ...
            if (!1 !== c.options.transitionStyle &&
                ...
                return (
                    c.swapSpeed(0), !0 === c.browser.support3d ?
        ...
        closestItem: function() {
            ...
            f.each(b, function(d, g) {
                e - a.itemWidth / 20 > b[d + 1] &&
                    ...
                    ((c = g),
                        (a.currentItem = !0 === a.options.scrollPerPage ?
        ...
        onVisibleItems: function() {
            ...
            this.visibleItems = [];
            for (
                a = this.currentItem; a < this.currentItem + this.options.items; a += 1
            )
